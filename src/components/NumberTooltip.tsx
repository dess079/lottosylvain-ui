...
interface NumberTooltipProps extends TooltipProps<any, any> {
  detailedStats?: Map<number, NumberStats>;
  totalDraws?: number;
}
  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg max-w-xs">
      <div className="space-y-2">
        {/* Numéro principal */}
        <p className="font-bold text-lg text-gray-900 dark:text-gray-100 border-b pb-2">
          Numéro {label}
        </p>
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <p className="text-sm font-semibold text-blue-600 dark:text-blue-400">{data.count} apparitions</p>
        </div>
        ...
        {numberStats && (
          <>
            {/* Dernière apparition */}
            <div className="grid grid-cols-2 gap-2">
              <p className="text-sm text-gray-600 dark:text-gray-400">Dernière apparition:</p>
            ...
            <div className="grid grid-cols-2 gap-2">
              <p className="text-sm text-gray-600 dark:text-gray-400">Cette année:</p>
            ...
            {/* Score de prédiction */}
            <div className="grid grid-cols-2 gap-2">
              <p className="text-sm text-gray-600 dark:text-gray-400">Score prédiction:</p>
            ...
            {/* Volatilité */}
            <div className="grid grid-cols-2 gap-2">
              <p className="text-sm text-gray-600 dark:text-gray-400">Volatilité:</p>
